...
const SHADER_VERTEX_FORMAT_FLOAT = 1
const SHADER_VERTEX_FORMAT_FLOAT2 = 2
const SHADER_VERTEX_FORMAT_FLOAT3 = 3
const SHADER_VERTEX_FORMAT_FLOAT4 = 4
const SHADER_VERTEX_FORMAT_UINT = 5
const SHADER_VERTEX_FORMAT_UCHAR4_NORMALIZED = 6
const SHADER_VERTEX_STEP_FUNCTION_PER_VERTEX = 1
const SHADER_VERTEX_STEP_FUNCTION_PER_INSTANCE = 2
